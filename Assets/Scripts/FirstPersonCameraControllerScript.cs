...
public class FirstPersonCameraControllerScript : MonoBehaviour
{
    ...
    [SerializeField]private List<CameraFoVAtSpeedStruct> cameraFoVAtSpeedList = new List<CameraFoVAtSpeedStruct>
    {
        new CameraFoVAtSpeedStruct(){
            speed = 0,
            fOV = 60
        },
        new CameraFoVAtSpeedStruct(){
    ...
    private AnimationCurve cameraFoVAtSpeedCurve;
    ...
    void Start()
    {
        ...
        cameraFoVAtSpeedCurve = new AnimationCurve();
        foreach (CameraFoVAtSpeedStruct value in cameraFoVAtSpeedList)
        {
            cameraFoVAtSpeedCurve.AddKey(value.speed, value.fOV);
        }
    }
    ...
    void Update()
    {
        ...
        CameraFOVManager.SetFoV(cameraFoVAtSpeedCurve.Evaluate(pm.GetMovementSpeed()));
        Debug.Log(cameraFoVAtSpeedCurve.Evaluate(pm.GetMovementSpeed()));
    }
